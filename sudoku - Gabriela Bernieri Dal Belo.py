...
def tem_g():
    if c1== [3,5,2,4,7,6,8,1,9] and c2 == [1,6,8,3,5,9,4,7,2] and c3 [4,9,7,8,2,1,6,3,5] and c4 == [2,4,5,9,6,7,3,8,1] and c5 == [9,8,6,1,4,3,5,2,7] and c6 == [7,3,1,2,8,5,9,6,4]:
        if c7 == [6,2,3,7,9,4,1,5,8] and c8 == [5,7,9,6,1,8,2,4,3] and c9 == [8,1,4,5,3,2,7,9,6]:
...
def jog():
    ...
    while not tem_g():
        ...
        n = int(input("qual o numero que você quer acrescentar: "))
        if l == 'A':
                if c == '1':
                    c1[0] = n
                elif c == '2':
